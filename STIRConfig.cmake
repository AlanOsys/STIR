...
set_and_check(STIR_INCLUDE_DIRS "${PACKAGE_PREFIX_DIR}/include/STIR-6.4")
# cannot use set_and_check on lists at present
# https://gitlab.kitware.com/cmake/cmake/issues/16219
#set(STIR_LIBRARY_DIRS "")
set(STIR_LIBRARIES analytic_FBP3DRP;analytic_FBP2D;analytic_SRT2D;analytic_SRT2DSPECT;analytic_GRD2D;analytic_DDSR2D;iterative_OSMAPOSL;iterative_KOSMAPOSL;iterative_OSSPS;scatter_buildblock;Shape_buildblock;eval_buildblock)
...
if (4.4.0 VERSION_LESS 3.12 OR CMAKE_VERSION VERSION_LESS 3.12)
   set(STIR_REGISTRIES ${PACKAGE_PREFIX_DIR}/share/STIR-6.4/src/IO_registries.cxx;${PACKAGE_PREFIX_DIR}/share/STIR-6.4/src/buildblock_registries.cxx;${PACKAGE_PREFIX_DIR}/share/STIR-6.4/src/recon_buildblock_registries.cxx;${PACKAGE_PREFIX_DIR}/share/STIR-6.4/src/data_buildblock_registries.cxx;${PACKAGE_PREFIX_DIR}/share/STIR-6.4/src/Shape_buildblock_registries.cxx;${PACKAGE_PREFIX_DIR}/share/STIR-6.4/src/modelling_registries.cxx;${PACKAGE_PREFIX_DIR}/share/STIR-6.4/src/spatial_transformation_registries.cxx;${PACKAGE_PREFIX_DIR}/share/STIR-6.4/src/scatter_registries.cxx)
else()
...
find_package(Boost 1.91.0 REQUIRED)

if (1)
  message(STATUS "ITK support in STIR enabled.")
  set(ITK_DIR "/home/di0/anaconda3/envs/petsird/lib/cmake/ITK-5.4")
...
if (TRUE)
  set(CERN_ROOT_CONFIG )
  find_package(CERN_ROOT 6.36.08 REQUIRED ${STIR_FIND_TYPE})
...
if(ON)
  find_package(PETSIRD CONFIG REQUIRED ${STIR_FIND_TYPE})
  message(STATUS "PETSIRD support in STIR enabled.")
  set(HAVE_PETSIRD TRUE)
endif()
